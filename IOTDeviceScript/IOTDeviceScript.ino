...
const char ssid[] = "RanchitoMexicano"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Ranchito0407"; // TODO cambiar por la contraseña de la red WiFi
...
const char MQTT_HOST[] = "3.238.146.247"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
const int MQTT_PORT = 8082;
const char MQTT_USER[] = USER;
//Contraseña de MQTT
const char MQTT_PASS[] = "user123456"; // TODO Reemplace ContrasenaMQTT por la contraseña correpondiente al usuario especificado.

//Tópico al que se recibirán los datos
// El tópico de publicación debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/out
const char MQTT_TOPIC_PUB[] = "colombia/tolima/ibague/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "colombia/tolima/ibague/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
 ...
 */
void sendSensorData(float temperatura, float humedad, float lux) {
  String data = "{";
  data += "\"temperatura\": "+ String(temperatura, 1) +", ";
  data += "\"humedad\": "+ String(humedad, 1) +", ";
  data += "\"luminosidad\": "+ String(lux, 1);
  data += "}";
...
float readLux() {
  ...
  // Convert the analog reading to a lux
  float lux = exp(float(sensorValue)/80.0);
 ...
 */
bool checkMeasures(float t, float h, float lux) {
